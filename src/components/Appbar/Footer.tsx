import { FaDiscord, FaDribbble, FaFacebook } from "react-icons/fa";
            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 font-semibold text-gray-900 dark:text-white">Resources</h2>
                            <ul className="text-gray-500 text-sm dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <Link href="#" className="hover:underline">Create tiplink</Link>
                                </li>
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 font-semibold text-gray-900 dark:text-white">Follow us</h2>
                            <ul className="text-gray-500 text-sm dark:text-gray-400 font-medium">
                                <li className="mb-4">
