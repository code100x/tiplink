...
const RightSideBar = () => {
  ...
  return (
    <div className="pr-6">
      <div className="flex flex-col space-y-4 p-12 rounded-lg text-bold bg-black">
        <button className="flex items-center space-x-4 p-4 text-white hover:bg-gray-800 rounded-lg transition ease-in-out duration-150 md:text-base">
          <svg
        ...
        <button className="flex items-center space-x-4 p-4 text-white hover:bg-gray-800 rounded-lg transition ease-in-out duration-150 md:text-base">
          ...
          <p className="font-semibold">Crowd Fund</p>
        </button>
