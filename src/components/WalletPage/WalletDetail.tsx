...
const WalletDetail = ({
  ...
  return (
    <div className="rounded-[22px] flex flex-col items-center gap-3 sm:w-[450px] md:w-[600px] border-2 p-7 sm:p-10 shadow-md dark:border dark:border-gray-500">
      <div className="flex flex-col items-start gap-2 w-full">
        ...
        <div className=" text-black dark:text-white opacity-80 text-xl  mb-6">
      ...
      {currentAction !== 'send' && currentAction !== 'swap' && (
        <div>
          ...
          <div className="w-full">
            <div className="p-2">
              <p className="flex justify-center text-slate-800 font-bold text-xl pt-4 pb-1 dark:text-slate-400">
