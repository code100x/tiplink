        ...
        <div>
            <div className = 'flex justify-center p-3 font-bold text-gray-500'>
                <div className = 'w-1/2 bg-slate-50 rounded-lg p-10 space-y-2'>
                    ...
                    <button className = 'flex border-gray-200 border-2 rounded-lg  p-4 w-full'>
                        <button>
                    ...
                    <button className = 'flex space-x-2 p-4 border-gray-200 border-2 w-full rounded-lg text-sm'>
                        <button>
                    ...
                    <button className = 'flex space-x-2 border-gray-200 border-2 w-full p-4 border-b-2 rounded-lg text-sm'>
                        <button >
