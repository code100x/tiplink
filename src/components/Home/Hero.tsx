    ...
    <section className=" items-center md:mt-40 mt-28">
      <div className=" container mx-auto px-4">
          <Image
            ...
            alt=""
            className="-z-10 absolute drop-shadow-lg -rotate-12 left-[10%] top-[30%] md:left-[20%] md:top-[15%] lg:left-[30%] lg:top-[18%]"
            width={70}
            height={70}
          />
          <Image
            ...
            alt=""
            className="-z-10 absolute rotate-12 drop-shadow-lg right-[8%] top-[25%] md:right-[15%] md:top-[32%] lg:right-[25%] lg:top-[42%] "
            width={70}
            height={70}
          />
          <div className="max-w-[600px] lg:max-w-[900px] mx-auto">
        <div className="bg-slate-400/10 backdrop-blur-[01px] py-5 rounded-2xl lg:w-auto">
