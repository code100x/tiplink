        ...
        <div>
          ...
          <div className="flex-2 rounded-lg sm:w-[450px] sm:h-[460px] border-2 p-5 sm:p-10 rounded-[20%]">
            <div className="text-gray-200 mb-4">
              <p className="text-gray-400 text-xs sm:text-sm semi-bold">Total Balance</p>
            </div>
            <p className="font-bold text-black opacity-80 text-xl sm:text-4xl mb-6">$ {money}</p>
            ...
            <div className = 'flex justify-center pt-4'>
              <div className = 'flex bg-gray-200 w-[100%] h-[12%] pt-2 rounded-lg space-x-16 p-2'>
                <button className = 'flex justify-center items-center bg-black opacity-80 rounded-lg w-[50%] text-white p-2  text-xl'>Token</button>
            ...
            <div>
              <div className = 'p-2'>
                  ...
                  <p className = 'flex justify-center text-gray-300 text-sm pt-2'>Start by buying or depositing funds:</p>
              </div>
              <div className = 'flex justify-center pt-2'>
                  <button className = 'bg-black opacity-80 rounded-lg text-white font-bold p-3'>+ Add Funds</button>
              </div>
            </div>
          </div>
        </div>
